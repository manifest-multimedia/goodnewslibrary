...
class SOMDN_WOO_Requirements
{
  ...
  private function check_wp_plugin($requirement): bool
  {
    $active = true;
  ...
  private function check_php_min_ver($requirement): bool
  {
    $active = true;
  ...
  function get_error_line_message($error, $type, $name): string
  {
    $error_message = $this->error_message;
