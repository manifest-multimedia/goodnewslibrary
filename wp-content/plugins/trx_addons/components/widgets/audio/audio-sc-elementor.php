	...
	function trx_addons_sc_widget_audio_add_in_elementor() {
		...
		class TRX_Addons_Elementor_Widget_Audio extends TRX_Addons_Elementor_Widget {
			...
			protected function _register_controls() {
				...
				$layouts = apply_filters('trx_addons_sc_type', trx_addons_components_get_allowed_layouts('sc', 'audio'), 'trx_sc_audio');
				$this->add_control(
					'type',
					[
				...
				$this->add_control(
					...
					[
						...
						'return_value' => '1',
						'condition' => ['type' => array ('default', 'simple', 'mono')],
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'default'      => '1',
						'return_value' => '1',
						'condition' => ['type' => array ('default', 'simple', 'modern')],
					]
				);
						...
						'fields'  => apply_filters(
							'trx_addons_sc_param_group_params', array_merge(
								[
									...
									[
										'name'        => 'link1',
										'label'       => __( 'Link one', 'trx_addons' ),
										'label_block' => false,
										'description' => wp_kses_data( __( 'This option only works for type "Modern"', 'trx_addons' ) ),
									...
									[
										'name' => 'icon1',
										'type' => 'trx_icons',
										'label' => __( 'Icon of first link', 'trx_addons' ),
										'label_block' => false,
										'default' => '',
									...
									[
										'name' => 'icon2',
										'type' => 'trx_icons',
										'label' => __( 'Icon of second link', 'trx_addons' ),
										'label_block' => false,
										'default' => '',
										'options' => trx_addons_get_list_icons(trx_addons_get_setting('icons_type')),
										'style' => trx_addons_get_setting('icons_type')
