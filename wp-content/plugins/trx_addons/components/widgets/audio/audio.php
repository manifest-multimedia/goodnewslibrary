...
class trx_addons_widget_audio extends TRX_Addons_Widget {
	...
	function widget( $args, $instance ) {
		...
		trx_addons_get_template_part(array(
			TRX_ADDONS_PLUGIN_WIDGETS . 'audio/tpl.'.trx_addons_esc($type).'.php',
			TRX_ADDONS_PLUGIN_WIDGETS . 'audio/tpl.default.php'
			),
			'trx_addons_args_widget_audio',
			apply_filters(
				'trx_addons_filter_widget_args',
				array_merge( $args, compact( 'type', 'title', 'subtitle', 'next_btn', 'next_text', 'prev_btn', 'prev_text', 'now_text', 'track_time', 'track_scroll', 'track_volume', 'media' ) ),
