...
( function(blocks, editor, i18n, element, components, hooks) {
	...
	// Add new attributes to the core blocks
	//----------------------------------------
	...
	wp.hooks.addFilter( 'blocks.registerBlockType',	'trx-addons/core/block', TrxAddonsCoreBlockAddAttribute );

	// Add fields to the Inspector panel
	...
	var TrxAddonsCoreBlockSave = function( element, blockType, attributes ) {
		if ( blockType.name == 'core/spacer' && ! trx_addons_is_off( attributes.alter_height ) ) {
