...
<div id="benefitscontent" class="esg_info_box esg-display-<?php echo $displs; ?>">
	...
	<div><strong><a href="https://www.essential-grid.com/help-center/" target="_blank"><?php esc_html_e("Get Premium Support", ESG_TEXTDOMAIN); ?></a></strong><?php esc_html_e(" - We help you in case of Bugs, installation problems, and Conflicts with other plugins and Themes ", ESG_TEXTDOMAIN); ?></div>
