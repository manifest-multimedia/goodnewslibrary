...
Please install and activate it before starting to use the theme RareRadio.
...
Theme documentation is available on http://rareradio.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in RareRadio is Fontello.
