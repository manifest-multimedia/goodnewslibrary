...
// Search page setup
// (uncomment lines with rareradio_storage_set_array2() calls if you want to override the relevant settings from Theme Options)
...
rareradio_storage_set_array( 'options_meta', 'blog_style', 'classic_3' );

// Sidebar position:
// Replace last parameter with one of values: none | left | right
rareradio_storage_set_array( 'options_meta', 'sidebar_position', 'none' );
