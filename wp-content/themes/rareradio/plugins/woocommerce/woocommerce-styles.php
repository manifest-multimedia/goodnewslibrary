...
if ( ! function_exists( 'rareradio_woocommerce_get_css' ) ) {
	add_filter( 'rareradio_filter_get_css', 'rareradio_woocommerce_get_css', 10, 2 );
	function rareradio_woocommerce_get_css( $css, $args ) {
...
/* Shop mode selector */
.rareradio_shop_mode_buttons a {
	color: {$colors['input_bd_color']};
}
.rareradio_shop_mode_buttons a:hover {
	color: {$colors['text_dark']};
}
.shop_mode_thumbs .rareradio_shop_mode_buttons a.woocommerce_thumbs,
...
.sidebar_inner .widget.widget_product_categories .widget_title {
	color: {$colors['extra_dark']};
}
.sidebar_inner .widget.widget_product_categories li a {
	color: {$colors['extra_dark']};
}
.sidebar_inner .widget.widget_product_categories li a:hover {
	color: {$colors['extra_link']};
}
.sidebar_inner .widget.widget_product_categories ul > li:before {
