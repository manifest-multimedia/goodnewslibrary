...
if ( ! function_exists( 'rareradio_mailchimp_get_css' ) ) {
	add_filter( 'rareradio_filter_get_css', 'rareradio_mailchimp_get_css', 10, 2 );
	function rareradio_mailchimp_get_css( $css, $args ) {
...
.mc4wp-form input[type="checkbox"] + .wpcf7-list-item-label {
