...
if ( ! function_exists( 'rareradio_gutenberg_add_theme_vars' ) ) {
	add_filter( 'rareradio_filter_add_theme_vars', 'rareradio_gutenberg_add_theme_vars', 10, 2 );
	function rareradio_gutenberg_add_theme_vars( $rez, $vars ) {
		return $rez;
	}
}
...
if ( ! function_exists( 'rareradio_gutenberg_get_css' ) ) {
	add_filter( 'rareradio_filter_get_css', 'rareradio_gutenberg_get_css', 10, 2 );
	function rareradio_gutenberg_get_css( $css, $args ) {
