...
if ( ! function_exists( 'rareradio_trx_addons_add_theme_vars' ) ) {
	add_filter( 'rareradio_filter_add_theme_vars', 'rareradio_trx_addons_add_theme_vars', 10, 2 );
	function rareradio_trx_addons_add_theme_vars( $rez, $vars ) {
...
if ( ! function_exists( 'rareradio_trx_addons_get_css' ) ) {
	add_filter( 'rareradio_filter_get_css', 'rareradio_trx_addons_get_css', 10, 2 );
	function rareradio_trx_addons_get_css( $css, $args ) {
...
.trx_addons_emotions .trx_addons_emotions_item.trx_addons_emotions_active:before {
	color: {$colors['extra_dark']};
}
...
.slider_outer.slider_outer_pagination_pos_bottom_outside .slider_pagination_wrap .swiper-pagination-bullet {
	background-color: {$colors['text_dark']};
}
...
.slider_outer.slider_outer_pagination_pos_bottom_outside .slider_pagination_wrap .swiper-pagination-bullet:hover {
	background-color: {$colors['text_dark']};
}
...
.widget_twitter .widget_content .sc_twitter_list li a {
	color: {$colors['text_hover3']};
}
.widget_twitter .widget_content .sc_twitter_list li a:hover {
	color: {$colors['extra_link']};
}
...
.widget_twitter .widget_content a {
	color: {$colors['extra_dark']};
}
.widget_twitter .widget_content a:hover {
	color: {$colors['extra_link']};
}
...
.sc_blogger.sc_blogger_excerpt .post_item .post_title a {
	color: {$colors['text_dark']};
}
.sc_blogger.sc_blogger_excerpt .post_item .post_title a:hover {
	color: {$colors['extra_link']};
}
.sc_blogger.sc_blogger_excerpt .post_meta_item.post_categories a {
	color: {$colors['inverse_light']};
	background: {$colors['alter_hover']};
}
.sc_blogger.sc_blogger_excerpt .post_meta_item.post_categories a:hover {
	color: {$colors['alter_hover']};
...
.sc_blogger.sc_blogger_excerpt .post_item .more-link {
	color: {$colors['extra_dark']};
	background: {$colors['text_dark']};
}
.sc_blogger.sc_blogger_excerpt .post_content_inner {
	color: {$colors['text_dark']};
}
...
.sc_blogger.sc_blogger_default .sc_item_featured .post_info_tr a:hover {
	background-color: transparent;
}
...
.sc_blogger.sc_blogger_default .post_meta .post_meta_item.post_categories a:hover {
	color: {$colors['alter_hover']};
}
...
.sc_courses_default .sc_courses_item_meta a:hover .sc_courses_item_meta_item {
	color: {$colors['text_dark']};
}
.sc_courses.sc_courses_default.modern .sc_courses_item_price a {
	color: {$colors['inverse_light']};
}
.sc_courses.sc_courses_default.modern .sc_courses_item_price a:hover {
	color: {$colors['alter_hover']};
}
.sc_courses.sc_courses_default.modern .sc_courses_item_price a:hover .sc_courses_item_period {
	color: {$colors['alter_hover']};
}
...
.sc_courses.sc_courses_default .sc_courses_item_image .sc_courses_item_meta a span {
	color: {$colors['inverse_light']};
}
...
.sc_events_classic .sc_events_item_meta_b {
	color: {$colors['alter_light']};
}
...
.sc_price_item_price_value {
	-webkit-text-stroke-color: {$colors['extra_dark']};
}
...
.post_share_top .socials_share .social_item .social_icon {
	background-color: {$colors['text_dark']};
}
.post_share_top .socials_share .social_item:hover,
.post_share_top .socials_share .social_item:focus {
	background-color: transparent;
}
.post_share_top .socials_share .social_item:hover .social_icon {
	background-color: {$colors['alter_link']};
}
.post_share_top .socials_share .social_item .social_icon,
.post_share_top .socials_share .social_item .social_icon i {
	color: {$colors['extra_dark']};
}
.post_share_top .socials_share .social_item:hover .social_icon,
.post_share_top .socials_share .social_item:hover .social_icon i {
	color: {$colors['extra_dark']};
}
...
.sc_team.sc_team_default [class*="trx_addons_column-"] {
	border-color: {$colors['bd_color']};
}
...
.sc_team.sc_team_short .sc_team_item_title a:hover {
	color: {$colors['extra_link']};
}
...
.mtphr-dnt-tick-contents .mtphr-dnt-tick:nth-child(even),
.mtphr-dnt-tick-contents .mtphr-dnt-tick:nth-child(even) a {
	color: {$colors['alter_hover']};
}
.mtphr-dnt-tick-contents .mtphr-dnt-tick a:hover {
	color: {$colors['text_hover2']};
}
.mtphr-dnt-tick-contents .mtphr-dnt-tick:nth-child(even) a:hover {
	color: {$colors['inverse_light']};
}
...
.trx_addons_popup .trx_addons_tabs_titles li {
	border-color: {$colors['alter_bg_color']};
}
...
.sc_layouts_login_menu .menu-item:not(.menu-item-has-children) .trx_addons_login_link:hover {
